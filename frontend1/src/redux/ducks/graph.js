// @flow
import { combineReducers, createSelector, createSlice, type PayloadAction as PA } from '@reduxjs/toolkit';
...
export type GraphState = {| selected: string[],  infoOpen: ?string, view: ViewState, nodePos: PosMemo |};
